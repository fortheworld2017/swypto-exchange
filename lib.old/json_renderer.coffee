...
#    bank_country:       withdrawal.bankCountry
#    bank_postalcode:    withdrawal.bankPostalCode
#    bank_city:          withdrawal.bankCity
#    preferred_currency: withdrawal.preferredCurrency

  bankWithdrawals: (withdrawals)->
    data = []
    for withdrawal in withdrawals
      data.push @bankWithdrawal withdrawal
    data
