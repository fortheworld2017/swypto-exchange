...
(function() {
  var BankWithdrawal, ClientSocket, FraudHelper, JsonRenderer, MarketHelper, MarketStats, Payment, Transaction, TransactionHelper, Wallet, exports, math, usersSocket, util;
  ...
  TransactionHelper = {
    ...
    cancelWithdrawal: function(payment, callback) {
      return Wallet.findUserWalletByCurrency(payment.user_id, payment.currency, function(err, wallet) {
        var totalWithdrawalAmount;
        if (err || !wallet) {
          return callback(err);
    ...
    createWithdrawal: function(data, callback) {
      return Wallet.findUserWallet(data.user_id, data.wallet_id, function(err, wallet) {
        if (!wallet) {
          return callback("Wrong wallet.");
        }
        ...
        return GLOBAL.db.sequelize.transaction(function(transaction) {
          return BankWithdrawal.create(data, {
            transaction: transaction
          }).complete(function(err, pm) {
            var totalWithdrawalAmount;
            if (err) {
